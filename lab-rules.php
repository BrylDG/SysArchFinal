    ...
    <nav class="fixed top-0 left-0 right-0 topnav shadow-lg z-50">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="desktop-menu hidden md:flex items-center space-x-1">
                    ...
                    <div class="nav-dropdown">
                        <button class="nav-dropdown-btn px-3 py-2 rounded-md text-sm font-medium text-light hover:bg-primary/20 <?php echo basename($_SERVER['PHP_SELF']) === 'sit-in-rules.php' || basename($_SERVER['PHP_SELF']) === 'lab-rules.php' ? 'bg-slate-700/20 text-white' : ''; ?>">
                            Rules
                        </button>
        ...
        <div id="mobileMenu" class="hidden md:hidden bg-primary">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a href="lab-rules.php" class="block px-3 py-2 rounded-md text-base font-medium text-secondary hover:bg-primary/20 bg-primary/50">Lab Rules</a>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
            <h1 class="text-3xl md:text-4xl font-bold text-primary mb-2">Laboratory Rules & Regulations</h1>
            <p class="text-secondary text-lg">University of Cebu - College of Information & Computer Studies</p>
        </div>
        <div class="bg-primary/10 px-4 py-2 rounded-full flex items-center">
            <i class="fas fa-info-circle text-primary mr-2"></i>
            <span class="text-primary font-medium">Effective: June 2023</span>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-primary hover:shadow-lg transition-all duration-300">
            <div class="p-6">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-xl font-bold text-dark">General Guidelines</h3>
                </div>
                <ul class="space-y-3">
                    <li class="flex items-start">
                        ...
                        <p class="ml-3 text-secondary">Maintain silence inside the lab</p>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                            <div class="h-5 w-5 rounded-full bg-primary/10 flex items-center justify-center">
                        ...
                        <p class="ml-3 text-secondary">No gaming allowed</p>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                            <div class="h-5 w-5 rounded-full bg-primary/10 flex items-center justify-center">
                        ...
                        <p class="ml-3 text-secondary">Internet surfing with permission only</p>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                            <div class="h-5 w-5 rounded-full bg-primary/10 flex items-center justify-center">
                        ...
                        <p class="ml-3 text-secondary">No illicit websites</p>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                            <div class="h-5 w-5 rounded-full bg-primary/10 flex items-center justify-center">
                        ...
                        <p class="ml-3 text-secondary">Don't delete files or change settings</p>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                            <div class="h-5 w-5 rounded-full bg-primary/10 flex items-center justify-center">
                        ...
                        <p class="ml-3 text-secondary">15-minute time allowance</p>
                    </li>
                </ul>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-blue-500 hover:shadow-lg transition-all duration-300">
            <div class="p-6">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-xl font-bold text-dark">Proper Conduct</h3>
                </div>
                <ul class="space-y-3">
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                        ...
                        <p class="ml-3 text-secondary">Enter only with instructor present</p>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                            <div class="h-5 w-5 rounded-full bg-blue-100 flex items-center justify-center">
                        ...
                        <p class="ml-3 text-secondary">Store bags in designated area</p>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                            <div class="h-5 w-5 rounded-full bg-blue-100 flex items-center justify-center">
                        ...
                        <p class="ml-3 text-secondary">Return chairs after use</p>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                            <div class="h-5 w-5 rounded-full bg-blue-100 flex items-center justify-center">
                        ...
                        <p class="ml-3 text-secondary">No food, drinks, or gum</p>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                            <div class="h-5 w-5 rounded-full bg-blue-100 flex items-center justify-center">
                        ...
                        <p class="ml-3 text-secondary">No vandalism or misconduct</p>
                    </li>
                </ul>
            </div>
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-100">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden border-l-4 border-red-500 hover:shadow-lg transition-all duration-300">
            <div class="p-6">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-xl font-bold text-dark">Disciplinary Actions</h3>
                </div>
                <ul class="space-y-3">
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                        ...
                        <p class="ml-3 text-secondary">First offense: Warning & possible suspension</p>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                            <div class="h-5 w-5 rounded-full bg-red-100 flex items-center justify-center">
                        ...
                        <p class="ml-3 text-secondary">Second offense: Strict disciplinary action</p>
                    </li>
                </ul>
            </div>
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-100">
        ...
        <div class="p-8 md:p-10 text-white">
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-2/3 mb-6 md:mb-0">
                    <h2 class="text-2xl md:text-3xl font-bold mb-4">Need Clarification?</h2>
                    <p class="text-white/90 mb-4">For any questions regarding lab rules and procedures, please contact the lab administrator or your course instructor.</p>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <button class="faq-toggle w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50 transition-colors">
                    <span class="font-medium text-lg text-dark">Can I attend without prior registration?</span>
                    <i class="fas fa-chevron-down transition-transform duration-200"></i>
                </button>
                <div class="faq-content px-6 pb-4 hidden">
                    <p class="text-secondary">No, all students must register for lab sessions at least 24 hours in advance. Walk-ins are not permitted to ensure proper lab capacity management.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <button class="faq-toggle w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50 transition-colors">
                    <span class="font-medium text-lg text-dark">What if I violate the dress code?</span>
                    <i class="fas fa-chevron-down transition-transform duration-200"></i>
                </button>
                <div class="faq-content px-6 pb-4 hidden">
                    <p class="text-secondary">First violation will result in a warning. Subsequent violations may lead to suspension of lab privileges for one week. Repeated violations may result in permanent ban from lab sessions.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <button class="faq-toggle w-full px-6 py-4 text-left flex justify-between items-center hover:bg-gray-50 transition-colors">
                    <span class="font-medium text-lg text-dark">How to appeal a suspension?</span>
                    <i class="fas fa-chevron-down transition-transform duration-200"></i>
                </button>
                <div class="faq-content px-6 pb-4 hidden">
